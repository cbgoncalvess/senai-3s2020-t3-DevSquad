  ...
  function Mytabs(){
    return(
      <Tab.Navigator  screenOptions={({ route }) => ({
        tabBarIcon: () => {
          if (route.name === 'Principal') {
            return(
              <Image source={{uri:'https://image.flaticon.com/icons/png/512/61/61088.png'}}
            ...
            return(
              <Image source={{uri:'https://image.flaticon.com/icons/png/512/25/25694.png'}}
              style={{width:20,height:20}}
              resizeMode='contain'
              />  
            );
      ...
      tabBarOptions={{
        ...
        <Tab.Screen name="Inscricoes" component={ListarVagasInscritas} options={{ headerShown: false }}/>
  ...
  return (
      <NavigationContainer>
        <Stack.Navigator initialRouteName="CandidatosAprovados">
          ...
          <Stack.Screen name="ListarVagasInscritas" component={Mytabs} options={{ headerShown: false }}/>
