...
let q25;
    ...
    // let a = PerfilPorcentagem(listResposta);
    //     return true;
    // } else {
    ...
    return (
        <div className="bodyPartTestePersonalidade">
            ...
            <div id="q1" className="Questionario">
                ...
                <InputRadius label="Divertido, espiritual e benéfico" name="q1" value="C"/>
                <InputRadius label="Confiável, meticuloso e previsíve" name="q1" value="O"/>
                <InputRadius label="Focado, determinado e persistente" name="q1" value="A"/>
            </div>
            ...
            <div id="q3" className="Questionario">
                ...
                <InputRadius label="Me deixe saber sua expectativa" name="q3" value="O"/>
                <InputRadius label="Lidere, siga ou saia do caminho" name="q3" value="A"/>
                <InputRadius label="Seja amigável, carinhoso e compreensivo" name="q3" value="C"/>
            </div>
            ...
            <div id="q6" className="Questionario">
                <h3>Eu penso que...</h3>
                <InputRadius label="Unidos venceremos, divididos perderemos" name="q6" value="C"/>
                <InputRadius label="O ataque é melhor que a defesa" name="q6" value="A"/>
                <InputRadius label="É bom ser manso, mas andar com um porrete" name="q6" value="I"/>
                <InputRadius label="Um homem prevenido vale por dois" name="q6" value="O"/>
            </div>

            <div id="q7" className="Questionario">
                <h3>Minha preocupação é...</h3>
                <InputRadius label="Gerar a ideia global" name="q7" value="I"/>
                <InputRadius label="Fazer com que as pessoas gostem" name="q7" value="C"/>
            ...
            <div id="q8" className="Questionario">
                ...
                <InputRadius label="Que todos tenham a chance de ser ouvidos" name="q8" value="C"/>
            </div>
            ...
            <div id="q9" className="Questionario">
                ...
                <InputRadius label="Tornar as pessoas confortáveis" name="q9" value="I"/>
            </div>
            ...
            <div id="q11" className="Questionario">
                ...
                <InputRadius label="Tudo segue conforme planejado" name="q11" value="O"/>
                <InputRadius label="Desfruto de coisas novas e estimulantes" name="q11" value="I"/>
            </div>

            <div id="q12" className="Questionario">
                <h3>Eu vejo a morte como...</h3>
                <InputRadius label="Uma grande aventura misteriosa" name="q12" value="I"/>
                <InputRadius label="Oportunidade de rever os falecidos" name="q12" value="C"/>
                <InputRadius label="Um modo de receber recompensas" name="q12" value="O"/>
                <InputRadius label="Algo que sempre chega muito cedo" name="q12" value="A"/>
            </div>

            <div id="q13" className="Questionario">
                <h3>Minha filosofia de vida é... </h3>
                <InputRadius label="Há ganhadores e perdedores, e eu acredito ser um ganhador" name="q13" value="A"/>
                <InputRadius label="Para eu ganhar, ninguém precisa perder" name="q13" value="C"/>
                <InputRadius label="Para ganhar é preciso seguir as regras" name="q13" value="O"/>
                <InputRadius label="Para ganhar, é necessário inventar novas regras" name="q13" value="I"/>
            </div>
            ...
            <div id="q14" className="Questionario">
                ...
                <InputRadius label="Realizar uma abordagem natural" name="q14" value="C"/>
            </div>

            <div id="q15" className="Questionario">
                <h3>Eu gosto de mudanças se...</h3>
                <InputRadius label="Me der uma vantagem competitiva" name="q15" value="A"/>
                <InputRadius label="For divertido e puder ser compartilhado" name="q15" value="C"/>
                <InputRadius label="Me der mais liberdade e variedade" name="q15" value="I"/>
                <InputRadius label="Melhorar ou me der mais controle" name="q15" value="O"/>
            </div>
            ...
            <div id="q18" className="Questionario">
                <h3>Meu lema é...</h3>
                <InputRadius label="Fazer o que precisa ser feito" name="q18" value="I"/>
            ...
            <div id="q19" className="Questionario">
                <h3>Eu gosto de....</h3>
                <InputRadius label="Complexidade, mesmo se confuso" name="q19" value="I"/>
            ...
            <div id="q20" className="Questionario">
                ...
                <InputRadius label="Algo que detesto desperdiçar" name="q20" value="A"/>
                <InputRadius label="Um grande ciclo" name="q20" value="C"/>
                <InputRadius label="Uma flecha que leva ao inevitável" name="q20" value="O"/>
                <InputRadius label="Irrelevante" name="q20" value="I"/>
            </div>

            <div id="q21" className="Questionario">
                <h3>Se eu fosse bilionário...</h3>
                <InputRadius label="Faria doações para entidades" name="q21" value="C"/>
                <InputRadius label="Criaria uma poupança avantajada" name="q21" value="O"/>
                <InputRadius label="Faria o que desse na cabeça" name="q21" value="I"/>
                <InputRadius label="Exibiria bastante com algumas pessoas" name="q21" value="A"/>
            </div>

            <div id="q22" className="Questionario">
                <h3>Eu acredito que...</h3>
                <InputRadius label="O destino é mais importante que a jornada" name="q22" value="A"/>
                <InputRadius label="A jornada é mais importante que o destino" name="q22" value="C"/>
                <InputRadius label="Um centavo economizado é um centavo ganho" name="q22" value="O"/>
                <InputRadius label="Bastam um navio e uma estrela para navegar" name="q22" value="I"/>
            </div>

            <div id="q23" className="Questionario">
                <h3>Eu acredito também que...</h3>
                <InputRadius label="Aquele que hesita está perdido" name="q23" value="A"/>
                <InputRadius label="De grão em grão a galinha enche o papo" name="q23" value="O"/>
                <InputRadius label="O que vai, volta" name="q23" value="C"/>
                <InputRadius label="Um sorriso ou uma careta é o mesmo para quem é cego" name="q23" value="I"/>
            </div>

            <div id="q24" className="Questionario">
                <h3>Eu acredito ainda que...</h3>
                <InputRadius label="É melhor prudência do que arrependimento" name="q24" value="O"/>
                <InputRadius label="A autoridade deve ser desafiada" name="q24" value="I"/>
                <InputRadius label="Ganhar é fundamental" name="q24" value="A"/>
                <InputRadius label="O coletivo é mais importante do que o individual" name="q24" value="C"/>
            </div>

            <div id="q25" className="Questionario">
                <h3>Eu penso que</h3>
                <InputRadius label="Não é fácil ficar encurralado" name="q25" value="I"/>
                <InputRadius label="É preferível olhar, antes de pular" name="q25" value="O"/>
