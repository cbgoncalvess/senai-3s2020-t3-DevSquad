        ...
        <div className="bodyPartVagasPublicadas">
            ...
            <div id="ModalRemoverTecnologia" className="ModalRemoverTecnologia none">
                ...
                <form>
                    <div className="select">
                        ...
                        <select className="div-select" onChange={e => SetNomeTecnologia(e.target.value)} value={NomeTecnologia}>
                    ...
                    <button onClick={DeletarTecnologia} className="btVaga">Adicionar</button>
                </form>
            </div>
            ...
            <div id="ModalAdicionarTecnologia" className="ModalAdicionarTecnologia none">
                ...
                <form>
                    <div className="select">
                        <label>Tecnologias</label>
                        <select className="div-select" onChange={e => SetIdTecnologia(e.target.value)} value={idTecnologia}>
                            <option value="0">Selecione uma área de atuação</option>
                            {
                                Tecnologias.map((item) => {
                                    return <option key={item.idTecnologia} value={item.idTecnologia}>{item.nomeTecnologia}</option>
                                })
                            }
                        </select>
                    </div>
                    <button onClick={AdicionarTecnologia} className="btVaga">Adicionar</button>
                </form>
            </div>
            ...
            <div id="ModalEditarVaga" className="ModalEditarVaga none">
                ...
                <form>
                    <Input className="InputCadastro" value={TituloVaga} name="TituloVaga" label="Titulo da Vaga" onChange={e => setTituloVaga(e.target.value)} />
                    <Input className="InputCadastro" value={Salario} name="Salario" label="Salario" onChange={e => setSalario(e.target.value)} />
                    <div className="select">
                        <label>Área</label>
                        <select className="div-select" onChange={e => setArea(e.target.value)} value={Area}>
                            ...
                            {
                                Areas.map((item) => {
                                    return <option key={item.idArea} value={item.idArea}>{item.nomeArea}</option>
                                })
                            }
                        </select>
                    </div>
                    ...
                    <div className="select">
                        ...
                        <select className="div-select" onChange={e => setTipoContrato(e.target.value)} value={TipoContrato}>
                    ...
                    <div className="text-area">
                        ...
                        <textarea value={DescricaoVaga} name="DescricaoVaga" onChange={e => setDescricaoVaga(e.target.value)}></textarea>
                        <br />
                        <label>Descrição da empresa</label>
                        <textarea value={DescricaoEmpresa} name="DescricaoEmpresa" onChange={e => setDescricaoEmpresa(e.target.value)}></textarea>
                        <br />
                        <label>Descrição dos benefícios</label>
                        <textarea value={DescricaoBeneficio} name="DescricaoBeneficio" onChange={e => setDescricaoBeneficio(e.target.value)}></textarea>
                    </div>
                    <br />
                </form>
                <div className="btVagaDiv">
                    <button className="btVaga" onClick={AtualizarVaga}>Editar</button>
                </div>
            </div>
            <Footer />
        </div>
